...
function single_post () {
	...
	/**************************************************************************/
	// Show the title.
	$header .= '<div class="h2 text-chunkfive p-0 m-0">'
...
/******************************************************************************/
// 2026-04-17: Adding a common navigation items.
function render_navigation_items() {
	...
	$ret = implode($nav_item_divider, $nav_items_array);
...
function szwergold_widgets_init() {
	register_sidebar(array(
		...
		'after_widget'  => '</div>',
		'before_title'  => '<div class="h4 text-chunkfive col col-12 p-0 m-0">',
		'after_title'   => '</div>',
	));
